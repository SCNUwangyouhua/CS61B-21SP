...
public class CapersRepository {
    ...
    public static void writeStory(String text) throws IOException {
        ...
        if (!Story_File.exists()) {
            ...
            byte[] oldContent = readContents(Story_File);
            Utils.writeContents(Story_File, oldContent, "\n", text);
        }
        String allContent = new String(readContents(Story_File));
    ...
    public static void makeDog(String name, String breed, int age) {
        // TODO
        Dog tempDog = new Dog(name, breed, age);
        tempDog.saveDog();
    ...
    public static void celebrateBirthday(String name) {
        // TODO
        Dog tempDog = Dog.fromFile(name);
        tempDog.haveBirthday();
        tempDog.saveDog();
    }
}
